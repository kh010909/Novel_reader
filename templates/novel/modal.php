...
<div class="modal fade" id="collectionModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">新增收藏</h5>    
            ...
            <form action="./collection/collection_add2.php" method="post">
                <div class="modal-body">
                    <textarea placeholder="請輸入收藏夾名稱" class="col-12 lh-base border-0" rows="1" name="collection"></textarea>
                </div>
                <div class="modal-footer">
